...
def makeStageTwoPyScript(targetData, httpPort, remoteLogFile, terminationToken):
    ...
    stageTwoPyContent = stageTwoPyContent + "import sys\n"
    stageTwoPyContent = stageTwoPyContent + "import time\n"
    stageTwoPyContent = stageTwoPyContent + "import shutil\n"
    ...
    stageTwoPyContent = stageTwoPyContent + "    try:\n"
    stageTwoPyContent = stageTwoPyContent + "      if sys.version_info >= (3, 0):\n"
    stageTwoPyContent = stageTwoPyContent + "        import urllib.request\n"
    stageTwoPyContent = stageTwoPyContent + "        with urllib.request.urlopen(url) as response, open(localName, 'wb') as out_file:\n"
    stageTwoPyContent = stageTwoPyContent + "          shutil.copyfileobj(response, out_file)\n"
    stageTwoPyContent = stageTwoPyContent + "      else:\n"
    ...
    for host in testConfig['TARGETS']:
        ...
        for sessionData in host['SESSION_DATASETS']:
            ...
            if 'PAYLOAD' in sessionData \
                ...
                and sessionData['MODULE']['NAME'].lower() == 'exploit/multi/handler':
                    launchBind = './msfconsole -qr ' + sessionData['RC_IN_SCRIPT_NAME'] + ' > ' + sessionData['RC_OUT_SCRIPT_NAME'] + ' 2> ' + sessionData['RC_OUT_SCRIPT_NAME'] + ' &\n'
                ...
                stageOneContent = stageOneContent + './msfconsole -qr ' + \
                                        sessionData['RC_IN_SCRIPT_NAME'] + ' > ' + sessionData['RC_OUT_SCRIPT_NAME'] + ' 2> ' + sessionData['RC_OUT_SCRIPT_NAME'] + ' &\n'
